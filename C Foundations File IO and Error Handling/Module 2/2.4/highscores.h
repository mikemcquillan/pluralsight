...
void saveHighScores()
{
    ...
    {
        fwrite(currentHighScores, sizeof(HighScore), NUM_HIGH_SCORES, pfile);
...
void loadHighScores()
{
    ...
    if(pfile != NULL)
    {
        ...
        if(fread(currentHighScores, sizeof(HighScore) * NUM_HIGH_SCORES,
                    NUM_HIGH_SCORES, pfile) != NUM_HIGH_SCORES)
        {
